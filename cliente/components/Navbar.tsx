        ...
        <div className="flex justify-between h-16">
          ...
          >
            ...
            <div className="hidden md:block">
              <h1 className="text-lg font-bold text-slate-800 tracking-tight leading-none">Nexus<span className="text-blue-600">DMS</span></h1>
          ...
          {/* Project Selector (Center/Prominent) */}
